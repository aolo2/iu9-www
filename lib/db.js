...
function getSubjects(callback) {
  mongo_client.get_subjects(callback)
}

function addSubject(subjectName, callback) {
  mongo_client.add_subject(subjectName, callback)
}

function getSubject(subjectId, callback) {
  mongo_client.get_subject(subjectId, callback)
}
