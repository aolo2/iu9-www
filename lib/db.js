...
function addUser(username, passwordHash, passwordSalt, role, callback) {
...
function openSession(session, role, callback) {
  redis_client.set(session, role, (err, result) => 
